...
/**
 * Unit tests for {@link IntegrationException}.
...
public class IntegrationExceptionTest {
  ...
  public void testIntegrationRuntimeException() {
    IntegrationException exception = new IntegrationException(component, message);
  ...
  public void testIntegrationRuntimeExceptionWithSolution() {
    IntegrationException exception = new IntegrationException(component, message, solution);
    String resultMessage = exception.getMessage();
    String expectedMessage = new ExpectedMessageBuilder()
        .component(component)
        .message(message)
  ...
  public void testIntegrationRuntimeExceptionWithCause() {
    IntegrationException exception = new IntegrationException(component, message, cause);
    String resultMessage = exception.getMessage();
    String expectedMessage = new ExpectedMessageBuilder()
        .component(component)
        .message(message)
  ...
  public void testIntegrationRuntimeExceptionWithCauseAndSolution() {
    IntegrationException exception = new IntegrationException(component, message, cause, solution);
    String resultMessage = exception.getMessage();
