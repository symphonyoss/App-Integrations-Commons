...
/**
 * Mock the behavior from the parser factory.
 * Created by rsanchez on 05/04/17.
 */
public class MockParserFactory implements WebHookParserFactory {

  private MessageMLVersion version;

  public MockParserFactory(MessageMLVersion version) {
